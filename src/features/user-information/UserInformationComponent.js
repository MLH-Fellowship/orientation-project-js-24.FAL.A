    ...
    function UserInformationComponent(){
        const [displayAddUserInformation, setDisplayAddUserInformation] = useState(false);
        const [dispalyAddUserInformationButton, setDisplayAddUserInformationButton] = useState(true);
            ...
            <div>
                {displayAddUserInformation ? (
                    ...
                    <ViewUserInformationComponent
                        onEditUserInfo={handleUserInfoToEdit}
                    />
                )}
                <br/>
                <br/>
                {!displayAddUserInformation && dispalyAddUserInformationButton && (
                    <button
                        onClick={onAddUserInformationButtonClick}
                    >
                        Add User Details
                    </button>
                )}
